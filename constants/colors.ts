export const SIDEBAR_BG = "#0a1f14";
export const SIDEBAR_ITEM_BG = "#0d2318";
export const SIDEBAR_HOVER = "#162e1e";
export const SIDEBAR_ACTIVE = "#1a3d28";
export const SIDEBAR_BORDER = "rgba(255,255,255,0.05)";
